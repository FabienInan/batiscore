      ...
      <main className="min-h-screen bg-white">
        ...
        <article className="max-w-3xl mx-auto px-4 py-12">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <h2>Qu&apos;est-ce qu&apos;une société phénix ?</h2>
            <p>
            ...
            <p>
              ...
              signal est rarement un faux positif : dans la très grande majorité des cas, le
              même numéro de téléphone indique que les deux entités appartiennent au même
              réseau d&apos;affaires.
            </p>

            <h3>Même adresse d&apos;affaires</h3>
            <p>
              Partager une adresse commerciale entre deux entreprises est courant dans les
              immeubles à bureaux, mais cela devient suspect lorsque peu d&apos;entreprises
              partagent la même adresse et qu&apos;une des entreprises antérieures à cette
              adresse a été fermée. Ce signal est particulièrement révélateur dans le cas des
              adresses résidentielles ou de petits bureaux où une seule ou deux entreprises
              sont enregistrées. Un entrepreneur qui opère de son domicile et qui recrée une
              entreprise au même endroit laisse une trace facile à détecter.
            </p>

            <h3>Nom similaire dans la même ville</h3>
            <p>
              Un autre signal révélateur est la similarité entre les noms des deux entreprises.
              ...
              le remplacement d&apos;un mot (&laquo; Construction &raquo; → &laquo; Rénovations &raquo;),
              l&apos;ajout ou la suppression d&apos;un terme géographique, ou un changement mineur
              dans la formulation juridique. Ces similarités nominales, combinées à la proximité
              géographique, constituent un indice fort de reconnexion.
            </p>

            <h3>Compagnie très récente avec dirigeant ayant des antécédents</h3>
            <p>
              ...
              décisions disciplinaires — le risque de reconnexion phénix est élevé. Ce signal
              nécessite de croiser les données du REQ (Registraire des entreprises du Québec),
              de la RBQ et de l&apos;OPC pour identifier les liens entre les dirigeants des deux
              entités. Dans certains cas, des prête-noms sont utilisés pour masquer la véritable
              appartenance de l&apos;entreprise.
            </p>

            <h2>Comment Batiscore détecte les sociétés phénix</h2>
            <p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 my-8 not-prose">
              ...
              <p className="text-orange-800 text-sm mb-4">
                ...
                truly nouveau ou s&apos;il s&apos;agit d&apos;une société phénix.
              </p>
              <Link
                href="/recherche"
            ...
            <h2>Que faire si vous suspectez une société phénix</h2>
            <p>
            ...
            <h3>Comment Batiscore détecte-t-il les sociétés phénix ?</h3>
            <p>
