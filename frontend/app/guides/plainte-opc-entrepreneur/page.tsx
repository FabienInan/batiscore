      ...
      <main className="min-h-screen bg-white">
        ...
        <article className="max-w-3xl mx-auto px-4 py-12">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <h2>Quand déposer une plainte à l&apos;OPC</h2>
            <p>
            ...
            <h2>Que peut faire l&apos;OPC</h2>
            <p>
              L&apos;OPC dispose de plusieurs moyens d&apos;action pour vous aider à résoudre un
              litige avec un entrepreneur. Voici ce que l&apos;Office peut faire une fois votre
              plainte déposée :
            </p>
            <ul>
              <li>
                <strong>Médiation entre les parties :</strong> dans la majorité des cas, l&apos;OPC
                tente d&apos;abord de faciliter un règlement à l&apos;amiable entre vous et
                l&apos;entrepreneur. Un agent communique avec les deux parties pour trouver une
                solution acceptable sans recourir à des mesures coercitives. C&apos;est
                l&apos;étape la plus fréquente et souvent la plus rapide.
              </li>
              <li>
                <strong>Enquête :</strong> si la médiation échoue ou si les faits signalés sont
                graves, l&apos;OPC peut ouvrir une enquête formelle. Les enquêteurs de l&apos;OPC
                disposent de pouvoirs d&apos;inspection et peuvent exiger la production de
                documents, visiter les lieux et interroger des témoins.
              </li>
              <li>
                <strong>Poursuite :</strong> lorsque l&apos;enquête révèle des infractions à la Loi
                sur la protection du consommateur, l&apos;OPC peut intenter des poursuites pénales
                contre l&apos;entrepreneur. Les amendes peuvent atteindre plusieurs milliers de
                dollars, selon la nature et la gravité de l&apos;infraction.
              </li>
              <li>
                <strong>Publication des décisions :</strong> l&apos;OPC publie les décisions
                disciplinaires et les condamnations sur son site Web. Cette transparence aide
                les autres consommateurs à identifier les entrepreneurs problématiques et constitue
                un puissant incitatif pour les entreprises à respecter leurs obligations.
              </li>
            </ul>
            <p>
              Il est important de noter que l&apos;OPC ne peut pas forcément vous obtenir un
              remboursement direct ou forcer l&apos;entrepreneur à exécuter les travaux. Son rôle
              est de faire respecter la loi et de favoriser un règlement. Si vous cherchez une
              compensation monétaire, la Cour du Québec (petite créance) peut être plus appropriée.
            </p>

            <h2>Délais importants</h2>
            <p>
              Le temps joue contre vous lorsque vous avez un litige avec un entrepreneur. Voici les
              délais à connaître :
            </p>
            <ul>
              <li>
            ...
            <ul>
              <li>
                ...
                <Link href="/guides/reclamation-rbq" className="text-orange-600 hover:text-orange-700 no-underline font-semibold">
                  Consultez notre guide sur les réclamations à la RBQ &rarr;
                </Link>
              </li>
              <li>
              ...
              <li>
                ...
                concerne la construction d&apos;un bâtiment neuf ou la rénovation majeure d&apos;un
                immeuble résidentiel couvert par le plan de garantie, vous pouvez déposer une
                réclamation auprès de la GCR. Le plan de garantie couvre notamment les malfaçons,
                les vices de construction et le non-achèvement des travaux.
              </li>
            </ul>
            <p>
            ...
            <h3>Combien de temps prend le traitement d&apos;une plainte à l&apos;OPC ?</h3>
            <p>
            ...
            <h3>Est-ce que déposer une plainte à l&apos;OPC coûte quelque chose ?</h3>
            <p>
            ...
            <h3>Puis-je déposer une plainte si je n&apos;ai pas de contrat écrit ?</h3>
            <p>
